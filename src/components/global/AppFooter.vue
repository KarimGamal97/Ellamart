        ...
        <v-row>
          ...
          <v-col cols="3">
            <v-card elevation="0" color="transparent">
              ...
              <v-card-text>Customer Services</v-card-text>
          ...
          <v-col cols="3">
            <v-card elevation="0" color="transparent">
              ...
              <v-card-text>Orders & Returns</v-card-text>
              <v-card-text>Contact Us</v-card-text>
              <v-card-text>Theme Faq's</v-card-text>
          ...
          <v-col cols="3" class="pt-5">
            <v-card elevation="0" color="transparent">
              ...
              <v-card-text class="d-flex" style="gap: 10px">
                ...
                685 Market Street San Francisco, CA 94105, US</v-card-text
              >
              <v-card-text class="d-flex" style="gap: 10px">
                <span class="pt-1">
                  <svg
                ...
                Call us:(090) 123-EllA</v-card-text
              >
              <v-card-text class="d-flex" style="gap: 10px">
                <span class="pt-1">
                  <svg
                ...
                Email: example@domain.com</v-card-text
              >
            </v-card>
            <div class="social d-flex" style="gap: 15px">
              <span
        ...
        <v-row class="pt-7" style="background-color: #fff">
          <v-col cols="6">
            <p>
              ...
              Reserved. Powered by
              <a href="https://karimgamal97.github.io/Karim_Gamal_Portfolio/"
                >Kariim</a
              >
            </p>
          </v-col>
