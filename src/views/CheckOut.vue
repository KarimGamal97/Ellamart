      ...
      <v-row>
        <v-col cols="7">
          ...
          >
            ...
            <v-divider length="100%" color="#000"></v-divider>
            <v-card-text style="font-size: 12px; color: #777"
              >All Rights Reserved
              <a
                style="font-weight: bold"
                href="https://mindtocode.org/"
                target="_blank"
                >MTC
              </a>
              © 2024</v-card-text
            ...
            >
              <v-badge :content="item.quantity" color="grey-darken-1">
                <img
                  ...
                  width="50"
                  height="50"
                  style="border-radius: 7px; border: 1px solid #f0f0f0"
                />
              </v-badge>
              <div class="title-parent flex-grow-1">
                ...
                >
                <v-card-text
                  style="font-size: 12px; color: #777; white-space: pre-wrap"
...
export default {
  data() {
    return {
      countries: ["Egypt", "Usa", "UK", "Russia", "South Africa"],
      dialog: false,
    };
  },
